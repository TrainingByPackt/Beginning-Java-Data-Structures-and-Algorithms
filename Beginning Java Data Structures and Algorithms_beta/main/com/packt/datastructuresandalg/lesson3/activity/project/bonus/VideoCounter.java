...
public class VideoCounter implements Comparable<VideoCounter>{
	
	private Long videoID;
	private int counter = 0;
	
	public VideoCounter(Long videoID) {
		super();
		this.videoID = videoID;
	}

	public VideoCounter(Long videoID, int counterStartFrom) {
		super();
		this.videoID = videoID;
     ...
     */
	@Override
	public int compareTo(VideoCounter otherCounter) {
