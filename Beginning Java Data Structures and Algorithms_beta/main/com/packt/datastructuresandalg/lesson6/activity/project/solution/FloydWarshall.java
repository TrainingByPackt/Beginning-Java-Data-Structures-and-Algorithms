...
public class FloydWarshall {
    ...
    public String[][] getNameOfStreets() {
	...
	public int[][] getNextToMAtrix() {
		return comeFromMatrix;
	}
    ...
    /**This methods returns names of the edges/roads on the shortest
     * path between the given start point and end point
     * 
     * @param fromNode starting point of the road
     * @param toNode ending point of the road
     * 
     * @return the names of the edges/roads on the shortest
     * path between the given start point and end point
     */
    public ArrayList<String> printPath(int fromNode, int toNode) {
    	//define return
        ArrayList<String> pathWithNames = new ArrayList<>();
        
        List<Integer> path = path(fromNode, toNode);
        
        for (int i = 0; i < path.size() -1; i++) {
        	int from = path.get(i);
        	int to = path.get(i+1);
        	
        	pathWithNames.add(nameOfStreets[from][to]);
		}
